...
---
--- Generates a set of cracks on the floor of a room.
---
--- @param seed number|nil The seed to use for the random number generator. If not provided, a random seed will be used.
--- @param initial_selection table|nil The initial selection of objects to use as the starting point. If not provided, the current editor selection will be used.
---
--- @return nil
---
ExtrasGenPrgs.CracksOnFloor = function(seed, initial_selection)
	local li = { id = "CracksOnFloor" }
	...
	prgdbg(li, 1, 4) for i, value in ipairs(initial_selection) do
		local _
		prgdbg(li, 2, 1) _, selection = sprocall(PrgPlaceObject.Exec, PrgPlaceObject, rand, {PlaceObj('PlaceObjectData', {EditorClass = "DecBunkerFloor_03",}),PlaceObj('PlaceObjectData', {EditorClass = "DecBunkerFloor_04",}),}, value, "Add to", selection) li[2] = nil
	end
