...
---
--- Generates dirt on the interior walls of rooms in the current selection.
---
--- @param seed number|nil The seed to use for the random number generator. If not provided, a random seed will be used.
--- @param initial_selection table|nil The initial selection of objects to process. If not provided, the current editor selection will be used.
---
--- @return nil
---
ExtrasGenPrgs.DirtOnWallsInterior = function(seed, initial_selection)
	local li = { id = "DirtOnWallsInterior" }
	...
	prgdbg(li, 1, 5) sprocall(PrgAlign.Exec, PrgAlign, rand, selection, "Wall interior")
