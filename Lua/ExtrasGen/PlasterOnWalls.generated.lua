...
---
--- Generates plaster on the walls of rooms in the current selection.
---
--- @param seed number|nil The random seed to use for generating the plaster placement. If not provided, a random seed will be used.
--- @param initial_selection table|nil The initial selection of objects to consider for plaster placement. If not provided, the current editor selection will be used.
---
--- @return nil
---
ExtrasGenPrgs.PlasterOnWalls = function(seed, initial_selection)
	local li = { id = "PlasterOnWalls" }
	...
	prgdbg(li, 1, 4) for i, value in ipairs(initial_selection) do
		local _
		prgdbg(li, 2, 1) _, selection = sprocall(PrgPlaceObject.Exec, PrgPlaceObject, rand, {PlaceObj('PlaceObjectData', {EditorClass = "DecWallBrickConcrete_01",}),}, value, "Add to", selection) li[2] = nil
	end
