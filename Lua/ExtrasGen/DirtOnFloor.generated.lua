...
---
--- Generates a dirt floor pattern on selected rooms.
---
--- @param seed number|nil The random seed to use for generating the dirt pattern. If not provided, a random seed will be used.
--- @param initial_selection table|nil The initial selection of objects to apply the dirt pattern to. If not provided, the current editor selection will be used.
---
--- @return nil
---
